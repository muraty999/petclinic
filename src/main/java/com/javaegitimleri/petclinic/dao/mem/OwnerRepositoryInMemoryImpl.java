...
public class OwnerRepositoryInMemoryImpl implements OwnerRepository {
	...
	public OwnerRepositoryInMemoryImpl() {
		...
		owner2.setId(2L);
		owner2.setFirstName("Murat");
		owner2.setLastName("Yilmaz");

		Owner owner3 = new Owner();
		owner3.setId(3L);
		owner3.setFirstName("Murat");
		owner3.setLastName("Morkoç");

		Owner owner4 = new Owner();
		owner4.setId(4L);
		owner4.setFirstName("Yusuf Eymen");
		owner4.setLastName("Yilmaz");
	...
	public void delete(Long id) {
		Owner owner = ownersMap.remove(id);
